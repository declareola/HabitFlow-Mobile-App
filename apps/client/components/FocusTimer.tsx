...
export const FocusTimer: React.FC = () => {
  const weeklyFocus = useHabitStore((state) => state.weeklyFocus);
        ...
        {showCompletionModal && (
          <div className="fixed inset-0 bg-[#0c0f10]/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            ...
            >
              ...
              <h3 className="font-display text-2xl font-black text-[#e1e3e4] mt-1">Excellent Focus, {userName}!</h3>
              ...
              <button
                ...
                className="w-full py-3 bg-[#95d4b3] hover:bg-[#b1f0ce] text-[#002114] font-bold rounded-xl transition-all cursor-pointer shadow-md shadow-[#95d4b3]/15 border-none"
              >
