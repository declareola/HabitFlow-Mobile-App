...
interface HabitEngineProps {
  habits: Habit[];
  onAddHabit: (habit: Omit<Habit, "id" | "streakCount" | "lastDone">) => void;
  onDeleteHabit: (id: string) => void;
  onScaleDownHabit: (id: string, step1: string, step2: string, step3: string) => void;
}

export const HabitEngine: React.FC<HabitEngineProps> = ({
  habits,
  onAddHabit,
  onDeleteHabit,
  onScaleDownHabit
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if (!title.trim() || !step1.trim() || !step2.trim() || !step3.trim()) {
      return alert("Please fill out all formulation steps!");
    }
              ...
              <div className="space-y-3 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className="text-[#8f9194] hover:text-[#e1e3e4] cursor-pointer"
                  >
                ...
                {briefingAccepted ? (
                  ...
                  <button
                    ...
                    className="py-2.5 px-5 bg-[#e9c176] hover:bg-[#ffdea5] text-[#412d00] font-bold text-xs rounded-xl flex items-center gap-2 transition-transform transform active:scale-98 cursor-pointer"
                  >
          ...
          <div className="p-6 rounded-2xl bg-[#1d2021]/80 border border-[#8f9194]/10">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div className="p-4 bg-[#111415] rounded-xl border border-[#44474a]/40 space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. immediately write top priority for 15 mins..."
                    className="w-full bg-[#1d2021] border border-[#44474a]/50 rounded-lg p-2.5 text-xs text-[#e1e3e4] focus:outline-none focus:border-[#95d4b3]"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. enjoy a small organic dark chocolate square..."
                    className="w-full bg-[#1d2021] border border-[#44474a]/50 rounded-lg p-2.5 text-xs text-[#e1e3e4] focus:outline-none focus:border-[#95d4b3]"
                  />
                </div>
              </div>
              ...
              <button
                ...
                type="submit"
                className="w-full py-3 bg-[#95d4b3] hover:bg-[#b1f0ce] text-[#002114] font-bold text-sm rounded-xl transition-all cursor-pointer"
              >
              ...
              {habits.map((h) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-2 text-[#ffb4ab] bg-[#93000a]/10 hover:bg-[#93000a]/30 rounded-lg hover:text-[#ffdad6] transition-colors cursor-pointer self-start"
                  >
