...
import { Milestone, LeaderboardUser } from "../types";
...
export const TrophyRoom: React.FC<TrophyRoomProps> = ({ milestones, leaderboard }) => {
  // Level & XP values
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-[#1d2021] to-[#12533a]/10 border border-[#8f9194]/10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div>
            ...
            <h2 className="text-2xl font-bold font-display text-[#e1e3e4] mt-0.5">Alex — "Architect" Level 6</h2>
          </div>
          <div className="text-right">
            <span className="font-mono text-xs text-[#c5c6ca]">{currentXP} XP / {targetXP} XP</span>
          ...
          <div className="p-6 rounded-2xl bg-[#1d2021]/80 border border-[#8f9194]/10">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-1.5 items-center">
                <span className="text-[10px] font-mono text-[#8f9194]">Low</span>
                ...
                <span className="text-[10px] font-mono text-[#8f9194]">Peak</span>
              </div>
            </div>
          ...
          <div className="p-6 rounded-2xl bg-[#1d2021]/80 border border-[#8f9194]/10">
            ...
            <div className="space-y-2.5">
              {[
                ...
                { label: "Circadian alignment routine done", value: "+240 XP", cat: "wellness" },
